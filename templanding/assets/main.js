...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.image.style1', { style: 'fade-down', speed: 2250, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		...
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'zoom-in', speed: 1250, intensity: 10, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 1000, intensity: 5, delay: 0, stagger: 250, replay: false });
		onvisible.add('form.style1', { style: 'fade-up', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
